        ...
        <Card className="max-w-md w-full text-center py-12">
          ...
          <CardContent className="space-y-4">
            <p className="text-muted-foreground">
              The birth certificate has been generated and is ready for verification. You can now download the official copy or return to dashboard.
            </p>
          </CardContent>
          <CardFooter className="flex flex-col gap-3">
            <Button className="w-full h-12 text-lg" asChild>
              <Link href="/portal/certificate/preview">Preview & Download Certificate</Link>
            </Button>
        ...
        <div className="mb-12 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 group">
            <div className="bg-primary h-8 w-8 rounded-lg flex items-center justify-center">
              <ChevronLeft className="text-background h-5 w-5 group-hover:-translate-x-0.5 transition-transform" />
            </div>
          ...
          <div className="text-right">
            ...
            <h2 className="text-xl font-headline font-bold">{steps[currentStep].title}</h2>
          </div>
        </div>
